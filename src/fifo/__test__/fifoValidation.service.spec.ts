...
describe('fifoValidation', () => {
  ...
  it('should throw Error if validation cause of action credit is negatif', () => {
    expect(() =>
      validationService.validateInitialeFifoValues(
        [
          { id: 'A', maxCredit: 20, credit: -20 },
  ...
  it('should throw Error if validation cause of action maxCredit is negatif', () => {
    expect(() =>
      validationService.validateInitialeFifoValues(
        [
          { id: 'A', maxCredit: -20, credit: 20 },
  ...
  it('should throw Error if validation cause of id is empty', () => {
    expect(() =>
      validationService.validateInitialeFifoValues(
        [
